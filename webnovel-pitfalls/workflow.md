...
| E-扩展5 | 感情机械化 | 感情线无误判/无回摆/反应方差过低，或全章出现双方都在“完美沟通” |
| E-扩展4 | 感情过审风险 | 隐晦情色过密、露骨性描写、高风险关系表达 |
...
| E-扩展4 | `explicit_sexual_content_hits` = 0 且 `high_risk_relationship_hits` = 0，并按 `explicitness_target_ratio` 判 `suggestive_erotic_risk_hits`（0%: <2；1-10%: ≤2；11-20%: ≤3） | 靠近上限 | 超出档位上限 | **露骨性描写>0 或 高风险关系>0**（回 `webnovel-plot-design`） |
...
| E-扩展4 | 感情过审风险 | | `suggestive_erotic_risk_hits`；`explicit_sexual_content_hits`；`high_risk_relationship_hits` | |
| F | 修为清单化 | | | |
| G | 设定说明书化 | | | |
